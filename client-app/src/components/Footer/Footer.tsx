      ...
      <section className={styles.wrapper_footer}>
        <div className={styles.content}>
          <div className={styles.description}>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate mollitia sunt perspiciatis nam sapiente
              magni similique temporibus qui maiores, incidunt provident adipisci obcaecati praesentium totam ab
              corporis quis ipsa autem?
            </p>
          </div>
