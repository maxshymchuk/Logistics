...
const news = [
  {
    ...
    image: newsImage1,
    title: 'Logistics Manager Analysis: Safety first… the future of commercial vehicles',
    source: 'https://www.logisticsmanager.com/logistics-manager-analysis-safety-first-the-future-of-commercial-vehicles'
  },
  {
    date: new Date(2020, 2, 5),
    image: newsImage2,
    title: `Coronavirus fallout pounds Chicago's logistics industry`,
    source: 'https://www.chicagobusiness.com/logistics/coronavirus-fallout-pounds-chicagos-logistics-industry'
  },
  {
    date: new Date(2020, 2, 4),
    image: newsImage3,
    title: 'ŠKODA’s logistics department is facing a planned generation change',
    source: 'https://www.eurologport.eu/skodas-logistics-department-is-facing-a-planned-generation-change'
  },
  {
    date: new Date(2020, 2, 2),
    image: newsImage4,
    title: 'Airbus’ new weight variant A330neo makes its first flight',
    source: 'https://www.eurologport.eu/airbus-new-weight-variant-a330neo-makes-its-first-flight'
  }
];
