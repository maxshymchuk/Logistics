        ...
        <section className={styles.wrapper_about}>
          ...
          <div className={styles.content}>
            <div className={styles.text}>
              <h2>Our Mission</h2>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam facere provident accusantium unde dolor
                beatae ducimus, odit repellat reprehenderit eaque voluptas, illo laborum? Praesentium rerum inventore
                asperiores fuga quibusdam consectetur.
              </p>
              <a>Read More ></a>
              <ul>
